...
<META HTTP-EQUIV="REFRESH" CONTENT="15;URL=resultados_1D.php"> 
...
// desempate 
$sql_resultado = "select * from concurso WHERE Id_prueba=".$Id_prueba." AND finaliza=1 ORDER BY clasificacion ASC, faltas_2R ASC, tiempo_2R ASC, faltas_RI ASC, tiempo_RI ASC";
...
$colorfila=0;
	if ($colorfila==0){ 
	 ...
	 $orden = $i+1;
            ...
            if($comando_resultado ['faltas_RI']==88||$comando_resultado ['faltas_RI']==99){            
            ...
            if($comando_resultado ['faltas_2R']==88||$comando_resultado ['faltas_2R']==99){
                 if($comando_resultado ['faltas_2R']==88){
                    print ("<TD colspan='2' bgcolor='".$color."'  >Retirado</TD>\n");
                 }else if($comando_resultado ['faltas_2R']==99){
                   print ("<TD colspan='2' bgcolor='".$color."'  >Eliminado</TD>\n");
                 }
            }else if($comando_resultado ['tiempo_2R']==0 || $comando_resultado ['tiempo_2R']==''){
                   print ("<TD colspan='2'  bgcolor='".$color."'></TD>\n");            
             }else {   
