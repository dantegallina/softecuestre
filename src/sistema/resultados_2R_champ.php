...
<META HTTP-EQUIV="REFRESH" CONTENT="15;URL=resultados_2R_champ.php"> 
<title></title>
<style type="text/css">
#contenedor
{
...
// listado
 ...
 // 1 recorrido  $sql_resultado = "select * from concurso WHERE Id_prueba=".$Id_prueba." AND finaliza=1 ORDER BY faltas_RI ASC, tiempo_RI ASC";
