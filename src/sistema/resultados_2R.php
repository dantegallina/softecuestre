...
<META HTTP-EQUIV="REFRESH" CONTENT="15;URL=resultados_2R.php"> 
...
// listado
 ...
 // 1 recorrido 
 //$sql_resultado = "select * from concurso WHERE Id_prueba=".$Id_prueba." AND finaliza=1 ORDER BY faltas_RI ASC, tiempo_RI ASC";
 // 2 recorrido 
 $sql_resultado = "select * from concurso WHERE Id_prueba=".$Id_prueba." AND finaliza=1 ORDER BY faltas_TOTAL ASC, tiempo_2R ASC";
 
  
 $sql_record = "SELECT MIN(tiempo_2R) as minimo FROM concurso WHERE Id_prueba=".$Id_prueba." AND faltas_2R = 0 AND tiempo_2R <> 0";
  // ver tiempo a batir sin faltas
...
if ($filas_resultado > 0)
      {
         ...
         print ("<TD width='10'><b>Faltas 2R</b></TD>\n");
         print ("<TD width='30'><b>Tiempo 2R</b></TD>\n");
         print ("<TD width='10'><b>Total Faltas</b></TD>\n");
	...
	if ($colorfila==0){ 
	 ...
	 $orden = $i+1;
            ...
            if($comando_resultado ['faltas_RI']==88){
              ...
              print ("<TD width='10'  bgcolor='".$color."'  >" . $comando_resultado ['faltas_RI'] . "</TD>\n");
              }
               print ("<TD width='30'  bgcolor='".$color."'  >" . $comando_resultado ['tiempo_RI'] . "</TD>\n");
               
                if($comando_resultado ['faltas_2R']==88){
               print ("<TD colspan='1' bgcolor='".$color."'  >Retirado</TD>\n");
            }else if($comando_resultado ['faltas_2R']==99){
               print ("<TD colspan='1' bgcolor='".$color."'  >Eliminado</TD>\n");
            }else{   
              print ("<TD width='10'  bgcolor='".$color."'  >" . $comando_resultado ['faltas_2R'] . "</TD>\n");
            }   
               
               print ("<TD width='30'  bgcolor='".$color."'  >" . $comando_resultado ['tiempo_2R'] . "</TD>\n");
               
                 if($comando_resultado ['faltas_TOTAL']==88){
               print ("<TD colspan='1' bgcolor='".$color."'  >Retirado</TD>\n");
               }else if($comando_resultado ['faltas_TOTAL']==99){
               print ("<TD colspan='1' bgcolor='".$color."'  >Eliminado</TD>\n");
            }else{  
              print ("<TD width='10'  bgcolor='".$color."'  >". $comando_resultado ['faltas_TOTAL'] . "</TD>\n");                              
               }
