...
<META HTTP-EQUIV="REFRESH" CONTENT="15;URL=resultados_champion.php"> 
<title></title>
<style type="text/css">
#contenedor
{
...
// 1 recorrido 
 ...
 // 2 recorrido $sql_resultado = "select * from concurso WHERE Id_prueba=".$Id_prueba." AND finaliza=1 ORDER BY faltas_TOTAL ASC, tiempo_2R ASC";
