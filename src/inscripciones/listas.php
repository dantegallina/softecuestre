                ...
                if (mysqli_num_rows($resultado)>0){
                    ...
                    while ($row = mysqli_fetch_assoc($resultado)) {
                        ...
                        if ($id != $prev_id) { // si el valor de Id_prueba cambió
                            ...
                            echo "<tr><th>Ord. Ing.</th><th>Jinete</th><th>Caballo</th><th>Categ.</th><th>Club</th><th>Hora</th></tr>";
                        }
...
<script>
    function enviar_valores(valor){
        ...
        location.href='https://softecuestre.com.ar/src/inscripciones/listas.php?valor=' + valor;
    }
</script>
