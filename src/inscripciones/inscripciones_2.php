...
<div>
    	<?PHP 
        	 include_once($_SERVER['DOCUMENT_ROOT'].'/menu/menu.htm');
        	 $valor=$_GET['valor'];
 	?>    
</div>
<header>
...
<main>
<form name="f1" action="inscribe.php" method="post">
        ...
        <legend>JINETE</legend>
            ...
            <div id="uno" name="uno" style="display:none" >
                <p>
					...
					<input type="button" name="selec" id="selec" value="Seleccione">
					
					<p><select id="multiple" style="display: none;" size="10"></select></p>
					
					F. Nacimiento :<input type="text" placeholder="Fecha de Nacimiento" name="f_nac_federado" id='f_nac_federado' value="" disabled="disabled">
           ...
           <div id="dos" name="dos" style="display:none" >
            <p>
				...
				DNI :<input type="text" placeholder="DNI" name="dni" id='dni' disabled="disabled">
        ...
        <legend>CABALLO</legend>
            ...
            <div id="tres" name="tres" style="display:none" >
                <p>
                    ...
                    <input type="button" name="selec_cab" id="selec_cab" value="Seleccione">
...
<script src="https://code.jquery.com/jquery-1.12.4.js"></script>
  <script>
    $( "#search_jinete" ).on( 'input', function() {
            ...
            $.ajax(
                {
                    url: 'https://softecuestre.com.ar/src/inscripciones/get_matches.php?term=' + $(this).val(),
    ...
    $( "#search_caballo" ).on( 'input', function() {
            ...
            $.ajax(
                {
                    url: 'https://softecuestre.com.ar/src/inscripciones/get_matches_caballos.php?term=' + $(this).val(),
                    success: function( data ) {
                        if ( data.length == 1 ) {
