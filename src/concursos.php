       ...
       <section class="regular slider" data-sizes="50vw">
            ...
            while ($valores = mysqli_fetch_assoc($query)) {
                if ($valores['fecha_fin']>=$fecha){
                    //$valores['fecha_fin']>$fecha & $valores['cierre_insc']>$fecha
                    echo "<form action='./sistema/concursos_prox.php' method='post'>";
                    ...
                    echo "<label>".mb_convert_encoding($valores['Nombre'], 'UTF-8', 'ISO-8859-1')."</label>";
                    echo "</button>";
                    echo "</div>";
                    echo "</form>";
                }    
